...
class MedicationDayFragment: AppCompatDialogFragment() {
    ...
    private val LOGGER = LoggerFactory.getLogger(MedicationDayFragment::class.java)
    ...
    inner class DayAdapter(val items : ArrayList<String>, val context: Context) : RecyclerView.Adapter<DayViewHolder>() {
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DayViewHolder {
            return DayViewHolder(LayoutInflater.from(context).inflate(R.layout.list_item_day, parent, false))
        }
