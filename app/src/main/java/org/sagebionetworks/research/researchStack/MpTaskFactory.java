...
import org.sagebionetworks.research.mpower.step.MpInstructionStep;
import org.sagebionetworks.research.mpower.step.MpInstructionSurveyItem;
import org.sagebionetworks.research.mpower.step.MpPhoneInstructionStep;
                ...
                switch (item.getCustomTypeValue()) {
                    case MpSurveyItemAdapter.MP_INSTRUCTION_SURVEY_ITEM_TYPE:
                        if (!(item instanceof MpInstructionSurveyItem)) {
                            throw new IllegalStateException("Error in json parsing, bp_instruction types must be BpInstructionSurveyItem");
                        }
                    ...
                    case MpSurveyItemAdapter.MP_INSTRUCTION_PHONE_SURVEY_ITEM_TYPE:
                        if (!(item instanceof MpInstructionSurveyItem)) {
                            throw new IllegalStateException("Error in json parsing, bp_phone_instruction types must " +
